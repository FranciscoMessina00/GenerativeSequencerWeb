#!/usr/bin/env node
/**
 * Runs the 12 `test/browser/*-check.html` pages for real, in headless Chromium,
 ...
 *
 * None of the 12 pages wrap their own script in try/catch or set a fallback
 ...
 */
const PAGES = [
  'bounded-dragnumber-check.html',
  'envelope-panel-check.html',
